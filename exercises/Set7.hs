...
step EggsAdded AddFlour = EggsFlourAdded
step EggsAdded AddSugar = EggsSugarAdded
step EggsSugarAdded AddFlour = EggsFlourSugarAdded
step EggsFlourAdded AddSugar = EggsFlourSugarAdded
step EggsFlourSugarAdded Mix = Mixed
...
passwordAllowed password (DoesNotContain chars) = not (passwordAllowed password (ContainsSome chars))
